...
1. [Introducción a las Peticiones HTTP](#introducción-a-las-peticiones-http)
2. [Paquete http](#paquete-http)
3. [Paquete dio](#paquete-dio)
4. [Métodos HTTP](#métodos-http)
5. [Autenticación](#autenticación)
6. [Interceptores](#interceptores)
7. [Manejo de Errores](#manejo-de-errores)
8. [Cancelación de Peticiones](#cancelación-de-peticiones)
9. [Cacheo de Respuestas](#cacheo-de-respuestas)
...
HTTP (HyperText Transfer Protocol) es el protocolo de comunicación utilizado para transferir datos en la web. En Flutter, las peticiones HTTP permiten comunicarse con servidores backend, APIs REST, y servicios web.
...
El manejo de peticiones HTTP en Flutter requiere considerar múltiples aspectos:

1. **Paquete http**: Simple y suficiente para casos básicos
2. **Paquete dio**: Más features (interceptores, cancelación, multipart)
3. **Autenticación**: Bearer tokens, JWT, refresh tokens
4. **Interceptores**: Logging, retry, caché, headers
5. **Manejo de errores**: Excepciones personalizadas, Result pattern
6. **Cancelación**: CancelToken para abortar peticiones
7. **Caché**: Memoria y persistente para optimizar rendimiento
8. **Refresh tokens**: Flujo completo con cola de peticiones

**Mejores Prácticas:**
- Usar patrón repositorio para separar lógica de API
- Implementar manejo de errores consistente
- Configurar interceptores reutilizables
- Cachear respuestas GET cuando sea apropiado
- Cancelar peticiones cuando el widget se desmonta
- Usar Result pattern para respuestas exitosas/erróneas
